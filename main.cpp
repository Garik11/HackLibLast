...
int main() {
	...
	CheatOption* option2 = new CheatOption(NULL, 
		...
		option2Keys);
	option2->AddÑavePatch(option2Cave_1, option2Bytes_1, 257);
	option2->AddÑavePatch(option2Cave_2, option2Bytes_2, 14);

	vector <int> option3Keys = { VK_NUMPAD3 };
	CheatOption* option3 = new CheatOption(NULL, 
		L"[NUM3] Устранение ошибки", 
		option3Keys);
	option3->AddÑavePatch(option3Cave_1, option3Bytes_1, 3);
